...
filer_storage_s3 = SimpleLazyObject(lambda: S3BotoStorage(location='smedia'))
...
filer_thumb_storage_s3 = SimpleLazyObject(lambda: S3BotoStorage(location='thumbs/smedia', reduced_redundancy=True))
